...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $a03 = isset($_POST['a03']) ? $_POST['a03'] : '';
    $a04 = isset($_POST['a04']) ? $_POST['a04'] : '';
    $a05 = isset($_POST['a05']) ? $_POST['a05'] : '';
    $a06 = isset($_POST['a06']) ? $_POST['a06'] : '';
    $a07 = isset($_POST['a07']) ? $_POST['a07'] : '';
    $a08 = isset($_POST['a08']) ? $_POST['a08'] : '';
    $a09 = isset($_POST['a09']) ? $_POST['a09'] : '';
	...
	if (trim($content)==""){
		$content="範例: 內含三條具體的說明。每一條說明應該簡潔明瞭，並清楚解釋其關鍵概念或步驟，並避免引用範例內容。";
	}
    ...
    if (!empty($office_document) && !empty($title)) {
	  ...
	  if (($content_tmp!="") && (substr(strtolower($title),0,1)!="q")){
		...
		--header "Authorization: Bearer '.$document01_key.'" \
