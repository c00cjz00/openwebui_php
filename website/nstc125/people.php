...
if (substr($office_document,0,3)=="(1)"){
	$question="建請科技部遴選適當的醫學研究機構，應用高單位負離子能夠極高效活化細胞之特性來躍升燒燙傷的醫療技術，以便造福全世界的燒燙傷病患。";		
}elseif (substr($office_document,0,3)=="(2)"){
	$question="請問如果自製火箭發射是以縮小版的方式實驗試射進行,是否需要跟國科會申請?";
}else{
	$question="請問如果自製火箭發射是以縮小版的方式實驗試射進行,是否需要跟國科會申請?";
}
?>
<main class="form-signin w-75 m-auto">
    <div class="container mt-5">
		<h5 class="mb-4"><b>民眾陳情回文: <?=$office_document;?></b></h5>
        <form id="myForm">
			...
			<div class="form-floating mb-3">
				...
				<label for="office_document" class="form-label">民眾陳情回文樣板</label>
			</div>
